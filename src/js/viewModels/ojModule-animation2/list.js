...
{     
    ...
    var data = [{id: 0, name: categorias[0].nombre, date: 'Ir', content: categorias[0]._id},
                {id: 1, name: categorias[1].nombre, date: 'Ir', content:categorias[1]._id},
                {id: 2, name: categorias[2].nombre, date: 'Ir', content:categorias[2]._id},
                {id: 3, name: categorias[3].nombre, date: 'Ir', content:categorias[3]._id},
                {id: 4, name: categorias[4].nombre, date: 'Ir', content:categorias[4]._id},
                {id: 5, name: categorias[5].nombre, date: 'Ir', content:categorias[5]._id}             
               ]
