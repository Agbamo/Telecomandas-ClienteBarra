 ...
 */
define(['ojs/ojcore', 'knockout', 'jquery','appController','ojs/ojknockout', 'ojs/ojmodule', 'ojs/ojmoduleanimations', 'ojs/ojnavigationlist'],
 function(oj, ko, $,app) {
    ...
    function IncidentsViewModel() {
      ...
      var self = this;
              ...
              this.modulePath = ko.pureComputed(
                function()
                {
                  return ('ojModule-animation/' + self.currentModule());
                }
              );
